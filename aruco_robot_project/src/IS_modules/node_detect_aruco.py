...
START_AUDIOBOOK_ALADDIN_ARUCO = 32

START_RELAX_ALL_ARUCO = 31
                ...
                if ids is not None:
                    ...
                    for id in ids:
                        if id == START_BREATH_ARUCO and time.time() > self.activation_timer + 0.5:
                            ...
                            self.rumpelstiltskin = True
                            self.audiobook_ON = True
                            print("START_AUDIOBOOK_RUMPELSTILTSKIN_ARUCO has been seen")
                        elif id == START_AUDIOBOOK_ALADDIN_ARUCO:
                            self.aladdin = True
                            self.audiobook_ON = True
                            print("START_AUDIOBOOK_ALADDIN_ARUCO has been seen")
                        elif id == END_ARUCO:
