...
class interactive_standby:
    ...
    def loop(self):
        ...
        while not rospy.core.is_shutdown():
            ...
            audiobooks_words_to_check_rumpelstiltskin = ['rumpelstiltskin', 'Rumpelstiltskin', 'Crumpled', 'crumple', 'Rumpole still skin', 'Rumpelstiltskin.']
            audiobooks_words_to_check_aladdin= ['aladdin', 'Aladdin.']
            ...
            if 'what' in self.speech_to_text.last_text.lower() and 'do' in self.speech_to_text.last_text.lower() and 'can' in self.speech_to_text.last_text.lower() and not self.speaking:
                ...
                audio_file = 'mp3_files/interactive_standby/interactive_standby/what_can_i_do.mp3'
            ...
            if self.aruco_detect.breath_ex_ON or any(word in self.speech_to_text.last_text.lower() for word in breath_words_to_check) and not self.speaking and triggered:
                # audio_file = 'mp3_files/interactive_standby/want_to_do_breath_ex.mp3'
                # play_thread = threading.Thread(target=self.audio_player.play_audio, args=(audio_file,))
                # play_thread.start()
                # play_thread.join()
                # self.speech_to_text.last_text= ''
            ...
            #Audio and aruco for arms
                ...
                relax_behaviour = RelaxBehavior()
                relax_behaviour.relax_arms_solo()
                self.aruco_detect.muscle_relax_ON = False
                self.stereovision.stop = True
                self.speech_to_text.stop = True
                break
            #Audio and aruco for back
                ...
                relax_behaviour = RelaxBehavior()
                relax_behaviour.relax_back_solo()
                self.aruco_detect.muscle_relax_ON = False
                self.stereovision.stop = True
                self.speech_to_text.stop = True
                break
            #Audio and aruco for tummy
                ...
                relax_behaviour = RelaxBehavior()
                relax_behaviour.relax_tummy_solo()
                self.aruco_detect.muscle_relax_ON = False
                self.stereovision.stop = True
                self.speech_to_text.stop = True
                break
            #Audio and aruco for legs
                ...
                relax_behaviour = RelaxBehavior()
                relax_behaviour.relax_legs_solo()
                self.aruco_detect.muscle_relax_ON = False
                self.stereovision.stop = True
                self.speech_to_text.stop = True
                break
            ...
            elif self.aruco_detect.rumpelstiltskin or any(word in self.speech_to_text.last_text.lower() for word in audiobooks_words_to_check_rumpelstiltskin) and not self.speaking and triggered:
