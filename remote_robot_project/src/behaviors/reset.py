...
class ResetBehavior:
    ...
    def run(self):
        ...
        eyes_thread = threading.Thread(target=self.cosmetics_controller.move_eyes, args=(2, 0.2))
        eyes_thread.start()  

        ears_thread = threading.Thread(target=self.cosmetics_controller.move_ears, args=(2, 0.5))
        ears_thread.start()
        ...
        neck_thread = threading.Thread(target=self.joints_controller.move_neck, args=(2, 34))
        neck_thread.start()
        neck_thread.join()        
